...
class Upload extends StatefulWidget {
  ...
  @override
  State createState() => _UploadState();
}
...
class _UploadState extends State<Upload> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Upload titolo'),
      ),
      body: _cryptoModel.isEmpty
          ? const CircularProgressIndicator() // Mostra un indicatore di caricamento se i dati non sono ancora stati ottenuti
          : ListView.builder(
